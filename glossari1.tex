...
%giro.}}
\newglossaryentry{gong}{name={Gon},description={Unità di misura dell'angolo, un gon vale 1/400 dell'angolo giro}}
...
interi}}
\newglossaryentry{pn}{type=symbols,name={$P_n$},description={Permutazione di n oggetti distinti}}
\newglossaryentry{dnk}{type=symbols,name={$D_{n,k}$},description={Disposizioni semplici di n oggetti a gruppi di k}}
